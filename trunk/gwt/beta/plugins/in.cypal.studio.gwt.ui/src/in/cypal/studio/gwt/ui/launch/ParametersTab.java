...
//	Button logAll;
	...
	public void initializeFrom(ILaunchConfiguration configuration) {
		...
		try {
			...
			case 1: styleDetail.setSelection(true); break;
			default: styleObfuscated.setSelection(true); break;
			}
			int logLevel = configuration.getAttribute(Constants.LAUNCH_ATTR_LOGLEVEL, 2);
			switch(logLevel) {
			case 0: logError.setSelection(true); break;
			case 1: logWarn.setSelection(true); break;
			case 2: logInfo.setSelection(true); break;
			case 3: logTrace.setSelection(true); break;
			case 4: logDebug.setSelection(true); break;
			default: logSpam.setSelection(true); break;
			}
			setDirty(false);
